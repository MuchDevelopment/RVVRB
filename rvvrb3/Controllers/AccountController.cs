...
namespace rvvrb3.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            try
            {
                var user = UserManager.Users.Single(u => u.Email.Equals(model.Email)); // where db is ApplicationDbContext instance
        ...
        {
            var profileImage = Session["ProfileImage"];
            ...
            if (profileImage == null)
            {
                ...
                string image = rv.AspNetUsers.Single(i => i.Id == userID).ProfileImage;

                Session["ProfileImage"] = image;
            }
            return (string) Session["ProfileImage"];
        }
    }
